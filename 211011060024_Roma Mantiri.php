...
<body>
    ...
    <div class="judul">
        <h1 style="text-align:center; margin-left: auto; margin-right: auto;">TUGAS AUTOMATA (NFA accepting language a
            (a + b) a*)</h1>
    </div>
    <div style="display:block; margin-left: auto; margin-right: auto;">
        <img style="width: 350px;" src="https://drive.google.com/uc?id=1Qbm6jmCAzR-5u0qqWfQCsQpdxtWkyUIc" alt="Gambar Penjelasan Tugas">
    </div>
    <br>
...
?>
    ...
    <br>
    <div style="text-align:center; margin-left: auto; margin-right: auto;">
        <a style="color: white; font-family:Helvetica;" href="https://github.com/romanouke/AutomataProject.git">Klik
            disini untuk mendownload Source Code</a>
    </div>
</body>
</html>